...
pub fn compute(func_idx: u32, module: &ModuleInfo) -> Result<u32> {
    ...
    while !body_reader.eof() {
        ...
        match opcode {
            ...
            | I64ExtendI32U | I64ExtendI32S | F32ConvertI32S | F32ConvertI32U | F32ConvertI64S
            | F32ConvertI64U | F64ConvertI32S | F64ConvertI32U | F64ConvertI64S
            | F64ConvertI64U | F32DemoteF64 | F64PromoteF32 | I32ReinterpretF32
